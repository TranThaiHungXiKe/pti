...
"color: rgb(255, 255, 255);")
        ...
        self.pushButton_recipe_Thitkho.setGeometry(QtCore.QRect(150, 220, 71, 61))
        font = QtGui.QFont()
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("D:/download/play-button.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButton.setIcon(icon1)
        self.pushButton.setIconSize(QtCore.QSize(80, 70))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_thitkho = QtWidgets.QPushButton(parent=self.widget_4)
        self.pushButton_thitkho.setGeometry(QtCore.QRect(230, 220, 93, 51))
        self.pushButton_thitkho.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("D:/download/book.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButton_thitkho.setIcon(icon2)
        self.pushButton_thitkho.setIconSize(QtCore.QSize(70, 70))
        self.pushButton_thitkho.setObjectName("pushButton_thitkho")
...
"color: rgb(255, 255, 255);")
        ...
        self.pushButton_thitkho_2 = QtWidgets.QPushButton(parent=self.widget_2)
        self.pushButton_thitkho_2.setGeometry(QtCore.QRect(290, 530, 93, 51))
        self.pushButton_thitkho_2.setText("")
        self.pushButton_thitkho_2.setIcon(icon2)
        self.pushButton_thitkho_2.setIconSize(QtCore.QSize(70, 70))
        self.pushButton_thitkho_2.setObjectName("pushButton_thitkho_2")
